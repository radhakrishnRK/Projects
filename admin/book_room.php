<?php 
   ...
   if(isset($_POST['book_room'])){
        ...
        if($_POST['room_type'] == 'Single Non-AC'){
            $query = "update single_non_ac_room set Client_Name = '$_POST[Client_Name]', Client_Id = $_POST[Client_Id],Mobile_Number = '$_POST[Mobile_Number]',Address = '$_POST[Address]',Check_in = '$_POST[Check_in]',Check_out = '$_POST[Check_out]',Status = 1 where Room_No = $_GET[rn]";
        }
        if($_POST['room_type'] == 'Single AC'){
            $query = "update single_ac_room set Client_Name = '$_POST[Client_Name]', Client_Id = $_POST[Client_Id],Mobile_Number = '$_POST[Mobile_Number]',Address = '$_POST[Address]',Check_in = '$_POST[Check_in]',Check_out = '$_POST[Check_out]',Status = 1 where Room_No = $_GET[rn]";
        }
    ...
    <body>
       ...
       <div class="row">
        ...
        <div class="row">
            ...
            <div class="form-group">
                <label for="email">Client_Name:</label>
